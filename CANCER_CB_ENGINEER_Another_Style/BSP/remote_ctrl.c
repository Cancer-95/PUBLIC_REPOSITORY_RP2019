 ...
 *            其中使用了串口二的接收端(空闲中断) 包含了遥控器控制底盘程序以及丢控保护程序
 *  					RX		PA3			DMA1_Stream5_ch4
 *****************************************************************************************************************/

#include "remote_ctrl.h"

uint8_t _USART2_DMA_RX_BUF[2][USART2_DMA_RX_BUF_LEN];
...
/*有关遥控器的全局变量*/
int8_t rc_connect; //丢控计数量
bool RC_IS_READY;  //就绪标志位
