...
#define UART4_DMA_RX_BUF_LEN    100

/*--------------------------发送---------------------------*/

//给视觉的识别号
enum Task_ID_For_Vision
{
	DISABLE_ALL_VISION            = 0,  //
	ENABLE_GROUND_GET_BOMB_VISION = 1,  //
	ENABLE_ISLAND_GET_BOMB_VISION = 2,  //
	ENABLE_FEED_BOMB_VISION       = 3,  //
	ENABLE_CLIMB_TUBE_VISION      = 4,  //
};
...
extern unsigned char _UART4_DMA_RX_BUF[UART4_DMA_RX_BUF_LEN];
