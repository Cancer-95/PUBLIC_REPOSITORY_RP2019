...
typedef struct
{
  ...
  float                 yaw_record;                   //记录的标定角度
	...
	bool                  landing_angle_record;
	float                 landing_angle;
	
	bool                  landing_angle_delay_time_record;
	uint32_t              landing_angle_delay_time;

//	bool                  climb_down_delay_time_record; //
//	uint32_t              climb_down_delay_time;        //
