...
#define LED_CAMERA_ON		   GPIO_SetBits(GPIOD,GPIO_Pin_13)
#define LED_CAMERA_OFF     GPIO_ResetBits(GPIOD,GPIO_Pin_13)
#define LED_CAMERA_TOGGLE  GPIOD->ODR ^= GPIO_Pin_13
